// Custom jquery for fetching category, book, chapter, example, example file
                ...
                $.ajax({
                    ...
                    success: function (example_file) {
                        ...
                        for (var a = 0, len = example_file.length; a < len; a++) {
                            console.log(example_file[a][0]);
                            $('#example-file-list > tbody:last-child')
                                .append("<tr><td><a href='/index?e_fid=" +
                                    example_file[a][0] + "' target='_blank'>" + example_file[a][1] +
                                    "</a></td><td>" + "Xcos file" + "</td><td><a href='/index?e_fid=" +
                                    example_file[a][0] + "' target='_blank'> Download" + "</a></td></tr>");
                        }
                    },
                    error: function (error) {
                        alert(error);
