function CANIMXY() {
    ...
    CANIMXY.prototype.define = function CANIMXY() {
        ...
        var exprs = new ScilabString([this.nbr_curves], [this.clrs], [this.siz], [this.win], [this.wpos.toString().replace(/,/g, " ")], [this.wdim.toString().replace(/,/g, " ")], [this.xmin], [this.xmax], [this.ymin], [this.ymax], [this.N]);
...
CANIMXY.prototype.set = function CANIMXY() {
    ...
    model.rpar = rpar
    model.ipar = ipar
    var exprs = new ScilabString([this.nbr_curves],[this.clrs],[this.siz],[this.win],[this.wpos],[this.wdim],[this.xmin],[this.xmax],[this.ymin],[this.ymax],[this.N]);
