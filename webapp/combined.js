...
function EXTRACT() {
	...
	this.initialvalue="int8(0)";
        ...
        scs_m.objs.push(scicos_block({
            ...
            graphics: scicos_graphics({
                orig: new ScilabDouble([56.016519999999986, -101.96488]), //299.96961, 261.584
                sz: new ScilabDouble([40, 40]),
                flip: new ScilabBoolean([true]), //false
                theta: new ScilabDouble([0]),
                exprs: new ScilabString(["int8(0)"], ["1"]),
                pin: new ScilabDouble([14]), //7
                pout: new ScilabDouble([13]), //5
                pein: new ScilabDouble(),
                peout: new ScilabDouble(),
                ...
                in_implicit: new ScilabString(["E"]),
                out_implicit: new ScilabString(["E"]),
                in_style: new ScilabString(["ExplicitInputPort;align=right;verticalAlign=middle;spacing=10.0;rotation=180"]), //left,0
                out_style: new ScilabString(["ExplicitOutputPort;align=left;verticalAlign=middle;spacing=10.0;rotation=180"]), //right,0
                in_label: new ScilabString([""]),
                out_label: new ScilabString([""]),
        ...
        scs_m_1.objs.push(scicos_block({
            gui: new ScilabString(["EDGETRIGGER"]),
            graphics: scicos_graphics({
                orig: new ScilabDouble([28.57143000000002, -50.00000000000006]), //288.58631, 257.1131
                sz: new ScilabDouble([60, 40]),
                flip: new ScilabBoolean([true]),
                theta: new ScilabDouble([0]),
                exprs: new ScilabString(["-1"]),
                pin: new ScilabDouble([6]), //5
                pout: new ScilabDouble([5]), //3
                pein: new ScilabDouble(),
                peout: new ScilabDouble(),
                gr_i: list(new ScilabString(["xstringb(orig(1),orig(2),&quot;EDGETRIGGER&quot;,sz(1),sz(2));"]), new ScilabDouble([8])),
                id: new ScilabString([""]),
        ...
        scs_m_1.objs.push(scicos_block({
            gui: new ScilabString(["IFTHEL_f"]),
            graphics: scicos_graphics({
                orig: new ScilabDouble([128.27380999999997, -40.0]), //388.28869, 247.1131
                sz: new ScilabDouble([60, 60]),
                flip: new ScilabBoolean([true]),
                theta: new ScilabDouble([0]),
                exprs: new ScilabString(["0"], ["0"]),
                pin: new ScilabDouble([5]), //3
                pout: new ScilabDouble(),
                pein: new ScilabDouble(),
                peout: new ScilabDouble([7], [0]),
                gr_i: list(new ScilabString(["xstringb(orig(1),orig(2),&quot;IFTHEL_f&quot;,sz(1),sz(2));"]), new ScilabDouble([8])),
            ...
            model: scicos_model({
                ...
                outtyp: new ScilabDouble(),
                evtin: new ScilabDouble(),
                evtout: new ScilabDouble([-1], [-1]), //1,1
                state: new ScilabDouble(),
                dstate: new ScilabDouble(),
                odstate: list(),
                rpar: new ScilabDouble(),
        ...
        scs_m_1.objs.push(scicos_block({
            gui: new ScilabString(["IN_f"]),
            graphics: scicos_graphics({
                orig: new ScilabDouble([20.0, -60.00000000000006]), //240.01488, 267.1131
                sz: new ScilabDouble([20, 20]),
                flip: new ScilabBoolean([true]),
                theta: new ScilabDouble([0]),
                exprs: new ScilabString(["1"]),
                pin: new ScilabDouble(),
                pout: new ScilabDouble([6]), //5
                pein: new ScilabDouble(),
                peout: new ScilabDouble(),
                gr_i: list(new ScilabString(["xstringb(orig(1),orig(2),&quot;IN_f&quot;,sz(1),sz(2));"]), new ScilabDouble([8])),
                id: new ScilabString([""]),
        ...
        scs_m_1.objs.push(scicos_block({
            gui: new ScilabString(["CLKOUTV_f"]),
            graphics: scicos_graphics({
                orig: new ScilabDouble([178.27380999999997, -135.71429000000003]), //398.28869, 181.39881
                sz: new ScilabDouble([20, 30]),
                flip: new ScilabBoolean([true]),
                theta: new ScilabDouble([0]),
                exprs: new ScilabString(["1"]),
        ...
        scs_m.objs.push(scicos_block({
            gui: new ScilabString(["EDGE_TRIGGER"]),
            graphics: scicos_graphics({
                orig: new ScilabDouble([28.571429999999992, -40.0]), //292.52452, 323.54888
                sz: new ScilabDouble([60, 40]),
                flip: new ScilabBoolean([true]),
                theta: new ScilabDouble([0]),
                exprs: new ScilabDouble(),
                pin: new ScilabDouble([18]), //14
                pout: new ScilabDouble(),
                pein: new ScilabDouble(),
                peout: new ScilabDouble([15]), //8
                gr_i: list(new ScilabString(["xstringb(orig(1),orig(2),&quot;EDGE_TRIGGER&quot;,sz(1),sz(2));"]), new ScilabDouble([8])),
                id: new ScilabString([""]),
                in_implicit: new ScilabString(["E"]),
                out_implicit: new ScilabDouble(),
        ...
        scs_m.objs.push(scicos_block({
            ...
            graphics: scicos_graphics({
                orig: new ScilabDouble([58.84304, -161.02106]), //302.79613, 202.52782
                sz: new ScilabDouble([40, 40]),
                flip: new ScilabBoolean([true]),
                theta: new ScilabDouble([0]),
                exprs: new ScilabString(["[0;1;1;1;0;0;1;0]"], ["0"]),
                pin: new ScilabDouble([13], [19], [20]), //[5], [16], [18]
                pout: new ScilabDouble([12]), //4
                pein: new ScilabDouble([15]), //8
                peout: new ScilabDouble(),
            ...
            model: scicos_model({
                ...
                blocktype: new ScilabString(["c"]),
                firing: new ScilabDouble(), //ScilabBoolean
                dep_ut: new ScilabBoolean([true, false]),
                label: new ScilabString([""]),
                nzcross: new ScilabDouble([0]),
                nmode: new ScilabDouble([0]),
        ...
        scs_m.objs.push(scicos_block({
            gui: new ScilabString(["SPLIT_f"]),
            graphics: scicos_graphics({
                orig: new ScilabDouble([154.54150665, -156.43154335]), //368.82793, 243.45067
                sz: new ScilabDouble([7.0, 7.0]), //0.3333333, 0.3333333
                flip: new ScilabBoolean([true]),
                theta: new ScilabDouble([0]),
                exprs: new ScilabDouble(),
                pin: new ScilabDouble([16]), //11
                pout: new ScilabDouble([14], [21], [0]), //7,20,0
                pein: new ScilabDouble(),
                peout: new ScilabDouble(),
                gr_i: list(new ScilabString(["xstringb(orig(1),orig(2),&quot;SPLIT_f&quot;,sz(1),sz(2));"]), new ScilabDouble([8])),
                id: new ScilabString([""]),
        ...
        scs_m.objs.push(scicos_block({
            gui: new ScilabString(["LOGICAL_OP"]),
            graphics: scicos_graphics({
                orig: new ScilabDouble([113.67907999999997, -204.29525]), //377.63217, 159.25363
                sz: new ScilabDouble([60, 40]),
                flip: new ScilabBoolean([true]),
                theta: new ScilabDouble([0]),
                exprs: new ScilabString(["1"], ["5"], ["5"], ["0"]),
                pin: new ScilabDouble([17]), //12
        ...
        scs_m.objs.push(scicos_block({
            gui: new ScilabString(["SPLIT_f"]),
            graphics: scicos_graphics({
                orig: new ScilabDouble([154.54150665, -176.81748335]), //368.82793, 223.06473
                sz: new ScilabDouble([7.0, 7.0]), //0.3333333, 0.3333333
                flip: new ScilabBoolean([true]),
                theta: new ScilabDouble([0]),
                exprs: new ScilabDouble(),
                pin: new ScilabDouble([12]),//4
                pout: new ScilabDouble([16], [17], [0]), //11,12,0
                pein: new ScilabDouble(),
                peout: new ScilabDouble(),
                gr_i: list(new ScilabString(["xstringb(orig(1),orig(2),&quot;SPLIT_f&quot;,sz(1),sz(2));"]), new ScilabDouble([8])),
                id: new ScilabString([""]),
        ...
        scs_m.objs.push(scicos_block({
            gui: new ScilabString(["IN_f"]),
            graphics: scicos_graphics({
                orig: new ScilabDouble([20.0, -50.0]), //243.95309, 333.54888
                sz: new ScilabDouble([20, 20]),
                flip: new ScilabBoolean([true]),
                theta: new ScilabDouble([0]),
                exprs: new ScilabString(["2"]),
                pin: new ScilabDouble(),
                pout: new ScilabDouble([18]), //14
                pein: new ScilabDouble(),
                peout: new ScilabDouble(),
                gr_i: list(new ScilabString(["xstringb(orig(1),orig(2),&quot;IN_f&quot;,sz(1),sz(2));"]), new ScilabDouble([8])),
                id: new ScilabString([""]),
        ...
        scs_m.objs.push(scicos_block({
            gui: new ScilabString(["IN_f"]),
            graphics: scicos_graphics({
                orig: new ScilabDouble([30.27161000000001, -171.02106]), //254.2247, 212.52782
                sz: new ScilabDouble([20, 20]),
                flip: new ScilabBoolean([true]),
                theta: new ScilabDouble([0]),
                exprs: new ScilabString(["1"]),
                pin: new ScilabDouble(),
                pout: new ScilabDouble([19]), //16
                pein: new ScilabDouble(),
                peout: new ScilabDouble(),
                gr_i: list(new ScilabString(["xstringb(orig(1),orig(2),&quot;IN_f&quot;,sz(1),sz(2));"]), new ScilabDouble([8])),
                id: new ScilabString([""]),
        ...
        scs_m.objs.push(scicos_block({
            gui: new ScilabString(["IN_f"]),
            graphics: scicos_graphics({
                orig: new ScilabDouble([30.27161000000001, -181.02106]), //254.2247, 202.52782
                sz: new ScilabDouble([20, 20]),
                flip: new ScilabBoolean([true]),
                theta: new ScilabDouble([0]),
                exprs: new ScilabString(["3"]),
                pin: new ScilabDouble(),
                pout: new ScilabDouble([20]), //18
                pein: new ScilabDouble(),
                peout: new ScilabDouble(),
                gr_i: list(new ScilabString(["xstringb(orig(1),orig(2),&quot;IN_f&quot;,sz(1),sz(2));"]), new ScilabDouble([8])),
                id: new ScilabString([""]),
        ...
        scs_m.objs.push(scicos_block({
            gui: new ScilabString(["OUT_f"]),
            graphics: scicos_graphics({
                orig: new ScilabDouble([164.87483999999998, -150.09821]), //388.82793, 233.45067
                sz: new ScilabDouble([20, 20]),
                flip: new ScilabBoolean([true]),
                theta: new ScilabDouble([0]),
                exprs: new ScilabString(["1"]),
                pin: new ScilabDouble([21]), //20
                pout: new ScilabDouble(),
                pein: new ScilabDouble(),
                peout: new ScilabDouble(),
                gr_i: list(new ScilabString(["xstringb(orig(1),orig(2),&quot;OUT_f&quot;,sz(1),sz(2));"]), new ScilabDouble([8])),
                ...
                in_implicit: new ScilabString(["E"]),
                out_implicit: new ScilabDouble(),
                in_style: new ScilabString(["ExplicitInputPort;align=left;verticalAlign=middle;spacing=10.0;rotation=0"]), //right
                in_label: new ScilabString([""]),
                style: new ScilabString(["OUT_f"])
            }),
            model: scicos_model({
        ...
        scs_m.objs.push(scicos_block({
            gui: new ScilabString(["OUT_f"]),
            graphics: scicos_graphics({
                orig: new ScilabDouble([242.25050999999996, -214.29525	]), //466.2036, 169.25363
                sz: new ScilabDouble([20, 20]),
                flip: new ScilabBoolean([true]),
                theta: new ScilabDouble([0]),
                exprs: new ScilabString(["2"]),
        ...
        scs_m_1.objs.push(scicos_link({
            xx: new ScilabDouble([152.57143000000002], [162.97618999999997], [184.27380999999997]), //357.15774,362.99107, 379.71726
            yy: new ScilabDouble([-30.000000000000057], [-70.00000000000006], [-10.0]), //277.1131,277.1131,277.1131
            id: new ScilabString(['drawlink']),
            thick: new ScilabDouble([0, 0]),
            ct: new ScilabDouble([1, 1]),
            from: new ScilabDouble([1, 1, 0]),
        ...
        scs_m_1.objs.push(scicos_link({
            xx: new ScilabDouble([64.0], [84.57143000000002]), //260.01488, 280.01488
            yy: new ScilabDouble([-50.00000000000006], [-30.000000000000057]), //277.1131, 277.1131
            id: new ScilabString(['drawlink']),
            thick: new ScilabDouble([0, 0]),
            ct: new ScilabDouble([1, 1]),
            from: new ScilabDouble([3, 1, 0]), //4,1,0
            to: new ScilabDouble([1, 1, 1])
        }));
        scs_m_1.objs.push(scicos_link({
            xx: new ScilabDouble([208.27380999999997], [208.27380999999997]), //408.28869,408.28869
            yy: new ScilabDouble([-44.0], [-101.71429000000003]), //241.39881, 211.39881
            id: new ScilabString(['drawlink']),
            thick: new ScilabDouble([0, 0]),
            ct: new ScilabDouble([5, -1]),
            from: new ScilabDouble([2, 1, 0]),
            to: new ScilabDouble([4, 1, 1]) //6,1,1
        }));
        scs_m.objs.push(scicos_link({
            xx: new ScilabDouble([142.84304], [164.87483999999998], [157.54150665]), //[351.36756], [368.82793], [368.82793]
            yy: new ScilabDouble([-141.02106], [-181.02106], [-169.98415]), //[222.52782], [222.52782], [223.06473]
            id: new ScilabString(['drawlink']),
            thick: new ScilabDouble([0, 0]),
            ct: new ScilabDouble([1, 1]),
            from: new ScilabDouble([3, 1, 0]),
            to: new ScilabDouble([6, 1, 1]) //10,1,1
        }));
        scs_m.objs.push(scicos_link({
            xx: new ScilabDouble([92.01651999999999], [70.22925999999998], [70.22925999999998], [94.84304]), //[291.39818], [274.18235], [274.18235], [294.2247]
            yy: new ScilabDouble([-81.96488], [-121.96488], [-171.02106], [-131.02106	]), //[281.584], [281.584], [232.52782], [232.52782]
            id: new ScilabString(['drawlink']),
            thick: new ScilabDouble([0, 0]),
            ct: new ScilabDouble([1, 1]),
            from: new ScilabDouble([1, 1, 0]),
        ...
        scs_m.objs.push(scicos_link({
            xx: new ScilabDouble([165.87483995], [164.87483999999998], [140.01651999999999]), //[368.82793], [368.82793], [345.68389]
            yy: new ScilabDouble([-149.514876675], [-121.96488], [-81.96488]), //[243.45067], [281.584], [281.584]
            id: new ScilabString(['drawlink']),
            thick: new ScilabDouble([0, 0]),
            ct: new ScilabDouble([1, 1]),
            from: new ScilabDouble([4, 1, 0]), //6,1,0
            to: new ScilabDouble([1, 1, 1])
        }));
        scs_m.objs.push(scicos_link({
            xx: new ScilabDouble([118.57142999999999], [170.74434], [170.74434], [118.84304]), //[322.52452], [374.69743], [374.69743], [322.79613]
            yy: new ScilabDouble([-44.0], [-85.71427999999997], [-155.30677], [-117.02106]), //[317.8346], [317.8346], [248.24211], [248.24211]
            id: new ScilabString(['drawlink']),
            thick: new ScilabDouble([0, 0]),
            ct: new ScilabDouble([5, -1]),
            from: new ScilabDouble([2, 1, 0]),
        ...
        scs_m.objs.push(scicos_link({
            xx: new ScilabDouble([165.87483995], [157.54150665]), //[368.82793], [368.82793]
            yy: new ScilabDouble([-169.90081667500002], [-149.59821]), //[223.06473], [243.45067]
            id: new ScilabString(['drawlink']),
            thick: new ScilabDouble([0, 0]),
            ct: new ScilabDouble([1, 1]),
            from: new ScilabDouble([6, 1, 0]), //10,1,0
            to: new ScilabDouble([4, 1, 1]) //6,1,1
        }));
        scs_m.objs.push(scicos_link({
            xx: new ScilabDouble([165.87483995], [164.87483999999998], [169.67907999999997]), //[368.82793], [368.82793], [369.06074]
            yy: new ScilabDouble([-169.98415], [-225.76218], [-184.29525]), //[223.06473], [177.7867], [179.25363]
            id: new ScilabString(['drawlink']),
            thick: new ScilabDouble([0, 0]),
            ct: new ScilabDouble([1, 1]),
            from: new ScilabDouble([6, 2, 0]), //10,2,0
            to: new ScilabDouble([5, 1, 1]) //9,1,1
        }));
        scs_m.objs.push(scicos_link({
            xx: new ScilabDouble([64.0], [84.57142999999999]), //[263.95309], [283.95309
            yy: new ScilabDouble([-40.0], [-20.0]), //[343.54888], [343.54888]
            id: new ScilabString(['drawlink']),
            thick: new ScilabDouble([0, 0]),
            ct: new ScilabDouble([1, 1]),
            from: new ScilabDouble([7, 1, 0]), //13,1,0
            to: new ScilabDouble([2, 1, 1])
        }));
        scs_m.objs.push(scicos_link({
            xx: new ScilabDouble([74.27161000000001], [94.84304]), //[274.2247], [294.2247]
            yy: new ScilabDouble([-161.02106], [-141.02106]), //[222.52782], [222.52782]
            id: new ScilabString(['drawlink']),
            thick: new ScilabDouble([0, 0]),
            ct: new ScilabDouble([1, 1]),
            from: new ScilabDouble([8, 1, 0]), //15,1,0
            to: new ScilabDouble([3, 2, 1])
        }));
        scs_m.objs.push(scicos_link({
            xx: new ScilabDouble([74.27161000000001], [94.84304]), //[274.2247], [294.2247]
            yy: new ScilabDouble([-171.02106], [-151.02106]), //[212.52782], [212.52782]
            id: new ScilabString(['drawlink']),
            thick: new ScilabDouble([0, 0]),
            ct: new ScilabDouble([1, 1]),
            from: new ScilabDouble([9, 1, 0]), //17,1,0
            to: new ScilabDouble([3, 3, 1])
        }));
        scs_m.objs.push(scicos_link({
            xx: new ScilabDouble([165.87483995], [180.87483999999998]), //[368.82793], [388.82793]
            yy: new ScilabDouble([-149.59821], [-140.09821]), //[243.45067], [243.45067]
            id: new ScilabString(['drawlink']),
            thick: new ScilabDouble([0, 0]),
            ct: new ScilabDouble([1, 1]),
            from: new ScilabDouble([4, 2, 0]), //6,2,0
            to: new ScilabDouble([10, 1, 1]) //19,1,1
        }));
        scs_m.objs.push(scicos_link({
            xx: new ScilabDouble([237.67907999999997], [258.25050999999996]), //[446.2036], [466.2036]
            yy: new ScilabDouble([-184.29525], [-204.29525]), //[179.25363], [179.25363]
            id: new ScilabString(['drawlink']),
            thick: new ScilabDouble([0, 0]),
            ct: new ScilabDouble([1, 1]),
            from: new ScilabDouble([5, 1, 0]), //9,1,0
            to: new ScilabDouble([11, 1, 1]) //21,1,1
        }));
        var model = scicos_model();
        model.sim = new ScilabString(["csuper"]);
        model.in = new ScilabDouble([1], [1], [1]);
...
//here in opar we have taken m[0] and m[1] as m will be a matrix [m[0],m[1]] due to which we will get error in opar data so we need to take it in fragments
        	model.opar=list(new ScilabDouble(m[0],m[1]),new ScilabDouble([parseFloat(den)]),new ScilabDouble([off]),new ScilabInteger([count])); 
...
/*function M_freq() {//old mfreq function
...
PuitsP.prototype.set = function PuitsP() {
 ...
 function PULSE_SC() {
        ...
        var scs_m_1 = scicos_diagram({
            ...
            props: scicos_params({
                //wpar: new ScilabDouble([600, 450, 0, 0, 600, 450]),
		wpar: new ScilabDouble([-162.7581,435.54369,67.607292,416.67644,827,479,0,15,827,480,715,167,1.4]),
                Title: new ScilabString(["SuperBlock"], ["/home/fady/Scicos_examples/"]),
                tol: new ScilabDouble([0.0001], [0.000001], [Math.pow(10, -10)], [100001], [0], [0], [0]),
